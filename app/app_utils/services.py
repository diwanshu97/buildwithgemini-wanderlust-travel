...
MEMORY_BANK_ID = "428468686228029440"
...
def get_memory_service():
    """Process-wide memory service: VertexAiMemoryBankService pointed at Agent Engine."""
    ...
    project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-04-69c9c83b08f1"
    location = (
        os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
        or os.environ.get("GOOGLE_CLOUD_LOCATION")
        or "us-east1"
    )
    engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or MEMORY_BANK_ID
